...
function formBuilderWidgetRender(this_widget){
  ...
  formBuilderBtnVGap = '2'; formBuilderBtnHGap = '0';
  ...
  jQuery.each(widgetPbFbFormFeilds, function(index, val){
    ...
    switch (val['fbFieldType']) {
      ...
      pbThisFormFieldWrapped =  '<div style="width:'+(thisFieldOptions['fbFieldWidth']-parseInt(formBuilderFieldHGap) - 0.25 )+'%; margin-right:'+formBuilderFieldHGap+'%; margin-top:'+formBuilderFieldVGap+'%; display:inline-block;">' + pbThisFormFieldLabel+'\n '+pbThisFormField +'</div>';
