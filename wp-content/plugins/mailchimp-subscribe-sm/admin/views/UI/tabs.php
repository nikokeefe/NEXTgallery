...
include(SMFB_PLUGIN_PATH.'admin/views/UI/tabs/form-analytics-function.php');
      ...
      if ( is_plugin_active( 'PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php' ) ) {
        ...
        $goProLink = '<a href="https://pluginops.com/optin-builder/?ref=editorBar" target="_blank" ><div class="goProButton">Want More Features ?</div></a>';
      } ?>
...
<div class="tabs">
  ...
  <div class="tab-content pb_editor_tab_content" style="overflow: hidden; ">
    <div id="tab1" class="tab active" style="margin: 0 auto !important;">
    ...
    <div id="tab4" class="tab" style="background: #fff;">
