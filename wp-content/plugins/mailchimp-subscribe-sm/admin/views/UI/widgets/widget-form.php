...
<div class="tab-content" style="box-shadow:none;">
	...
	<div class="pbp_form" style="background: #fff; padding:20px 10px 20px 25px; width: 99%;">
		...
		<input type="text" class=" formBtnBgColor" id="formBtnBgColor" value='#333333'>
		<br><br><hr><br>
        <label>Hover Background Color :</label>
        <input type="text" class=" formBtnHoverBgColor" id="formBtnHoverBgColor" data-alpha='true' value='#333333'>
        <br><br><hr><br>
        <label>Hover Text Color :</label>
        <input type="text" class=" formBtnHoverTextColor" id="formBtnHoverTextColor" data-alpha='true' value=''>
        <br><br><hr><br>
        <label>Button Text Color :</label>
        <input type="text" class=" formBtnColor" id="formBtnColor">
        <br><br><hr><br>
        <div>
			<h4>Font size
		        <span class="responsiveBtn rbt-l " > <i class="fa fa-desktop"></i> </span>   
        ...
        <input type="text" class=" formBtnBorderColor" id="formBtnBorderColor" value='#ffffff'>
        <br><br><hr><br>
        ...
        <input type="text" class=" formSuccessMessageColor" id="formSuccessMessageColor">
        <br><br><hr><br>
