...
<div id="subsListDownloadbtn" class="btn-green"  style='color:#fff; text-decoration:none;padding:15px; float: left; margin-left:50px;' >DOWNLOAD LIST</div>
  <br>
  <br>
  <form method="post" class="empty_button_form" action="<?php echo admin_url('admin-ajax.php?action=smfb_subscribe_list_empty'); ?>" style="width:350px; float: right;">
  ...
  <script type="text/javascript">
            ...
            ( function( $ ) {
                ...
                $('#subsListDownloadbtn').on('click',function(){
                    ...
                    $('.popb_confirm_subMessage').append('<a href="https://pluginops.com/optin-builder" target="_blank">Learn More </a>');
