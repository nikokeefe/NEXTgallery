...
<?php 
  ...
  if (is_plugin_active( 'PluginOps-S-Builder-Extensions-Pack/extension-pack.php' )  || is_plugin_active('PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php') ) {
    ...
    $templatesOneExtLink = '<a href="https://pluginops.com/optin-builder?ref=extensionsTemplatesPack"> <button class="ext_cta"> '.__( 'Get All Features', 'mailchimp-subscribe-sm' ).'</button> </a>';
  }

  if (is_plugin_active( 'PluginOps-S-Builder-Extensions-Pack/extension-pack.php' )  || is_plugin_active('PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php') ) {
      $globalRowExtLink = '<button class="ext_cta_installed">'.__( 'Installed', 'mailchimp-subscribe-sm' ).'  </button>';
  }else{
    $globalRowExtLink = '<a href="https://pluginops.com/optin-builder?ref=extensionsGRow"> <button class="ext_cta"> '.__( 'Get All Features', 'mailchimp-subscribe-sm' ).'</button> </a>';
  }

  if (is_plugin_active( 'PluginOps-S-Builder-Extensions-Pack/extension-pack.php' )  || is_plugin_active('PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php') ) {
      $exportDuplicateExtLink = '<button class="ext_cta_installed">'.__( 'Installed', 'mailchimp-subscribe-sm' ).'  </button>';
  }else{
    $exportDuplicateExtLink = '<a href="https://pluginops.com/optin-builder?ref=extensionsExport"> <button class="ext_cta"> '.__( 'Get All Features', 'mailchimp-subscribe-sm' ).'</button> </a>';
  }

  if (is_plugin_active( 'PluginOps-S-Builder-Extensions-Pack/extension-pack.php' )  || is_plugin_active('PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php') ) {
      $mailchimpExtLink = '<button class="ext_cta_installed">'.__( 'Installed', 'mailchimp-subscribe-sm' ).'  </button>';
  }else{
    $mailchimpExtLink = '<a href="https://pluginops.com/optin-builder?ref=extensionsIntegrations"> <button class="ext_cta"> '.__( 'Get All Features', 'mailchimp-subscribe-sm' ).'</button> </a>';
  }
  ...
  if (is_plugin_active( 'PluginOps-S-Builder-Extensions-Pack/extension-pack.php' )  || is_plugin_active('PluginOps-Optin-Builder-Extensions-Pack/extension-pack.php') ) {
    ...
    $formBuilderDBExt = '<a href="https://pluginops.com/optin-builder?ref=extensionsDatabase"> <button class="ext_cta"> '.__( 'Get All Features', 'mailchimp-subscribe-sm' ).'</button> </a>';
  }
      ...
      <div id="tab1" class="tab active" style="background: #f1f1f1; padding:10px 30px;">
        <div class="pb_ext-card">
          ...
          <div style="height: 180px;">
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionsTemplates'"> Premium Templates & Blocks </a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/6.png' ?>"> </div>
           <div style="height: 180px;"> 
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionsDatabase'"> Database Extension </a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/2.png' ?>"> </div>
           <div style="height: 180px;"> 
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionsExport'"> Export & Duplicate</a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/5.png' ?>"> </div>
           <div style="height: 180px;"> 
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionsEmbed'"> Advanced Placement </a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/13.png' ?>"> </div>
           <div style="height: 180px;"> 
              <h3> <a href="https://pluginops.com/optin-builder?ref='extensionsMCI'"> A/B Testing </a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/3.png' ?>"> </div>
           <div style="height: 180px;"> 
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionsMCI'"> MailChimp Integration </a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/7.png' ?>"> </div>
           <div style="height: 180px;"> 
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionGRI'"> Get Response Integration </a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/9.png' ?>"> </div>
           <div style="height: 180px;"> 
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionACI'"> Active Campaign Integration </a> </h3>
        ...
        <div class="pb_ext-card">
          <div class="pb_extImg_container"> <img src="<?php echo SMFB_PLUGIN_URL.'/images/extension-icons/8.png' ?>"> </div>
           <div style="height: 180px;"> 
            <h3> <a href="https://pluginops.com/optin-builder?ref='extensionCMI'"> Campaign Monitor Integration </a> </h3>
