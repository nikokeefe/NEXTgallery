...
function wssf_admin_scripts( ) {
	...
	if ($screen_id->id == "pluginops_forms_page_optin-builder-new-optin-page") {
		...
		if (in_array($screen_id->post_type  , $screenIDsToShow, false) ){
			...
			wp_enqueue_script( 'smfb-backbone-builder-jqueryUI', SMFB_PLUGIN_URL.'/js/Backbone-resources/jquery-ui.js', array( 'jquery' ), false, true );
		    ...
		    wp_enqueue_script( 'smfb-pen-editor-js-script', SMFB_PLUGIN_URL.'/js/pen-editor/src/pen.js', array( 'jquery' ), false, true );

		    wp_enqueue_script( 'smfb-pen-editor-js-script-markdown', SMFB_PLUGIN_URL.'/js/pen-editor/src/markdown.js', array( 'jquery' ), false, true );

		    wp_enqueue_style( 'smfb-pen-editor-js-style', SMFB_PLUGIN_URL.'/js/pen-editor/src/pen.css' );
