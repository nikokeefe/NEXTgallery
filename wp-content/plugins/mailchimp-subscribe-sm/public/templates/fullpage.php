...
if (isset($isPopUpFullPageTemplate) || $selecteOptinType == 'Full Page') {
  ...
  if ($isPopUpFullPageTemplate == true || $selecteOptinType == 'Full Page') {
    ...
    <style type="text/css">
      ...
      <div class="pluginops-modal" id="POPB-modal-overlay_<?php echo($this_popup_unique_Id); ?>" style=" position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; overflow: none; display: none; overflow: auto;">
