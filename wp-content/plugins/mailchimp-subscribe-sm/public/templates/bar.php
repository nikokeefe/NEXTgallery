...
if (isset($isPopUpBarTemplate) || $selecteOptinType == 'Bar') {
  ...
  if ($isPopUpBarTemplate == true || $selecteOptinType == 'Bar') {
    ...
    <style type="text/css">
      ...
      <div class="pluginops-modal" id="POPB-modal-overlay_<?php echo($this_popup_unique_Id); ?>" style=" position: fixed; z-index: 9999; overflow: hidden; width: 100vw; max-height:50vh !important;  display: none; left: 0; right: 0;">
