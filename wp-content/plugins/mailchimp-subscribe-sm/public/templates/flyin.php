...
if (isset($isPopUpFlyInTemplate) || $selecteOptinType == 'Fly In' ) {
  ...
  if ($isPopUpFlyInTemplate == true || $selecteOptinType == 'Fly In') {
    ...
    <style type="text/css">
      ...
      <div class="pluginops-modal" id="POPB-modal-overlay_<?php echo($this_popup_unique_Id); ?>" style=" position: fixed; z-index: 9999; max-width: 60%; display: none; padding: 10px 0 0 10px;">
