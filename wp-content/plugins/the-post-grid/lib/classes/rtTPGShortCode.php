			...
			if ( $scID && ! is_null( get_post( $scID ) ) ) {
				...
				if ( $postQuery->have_posts() ) {
					...
					while ( $postQuery->have_posts() ) : $postQuery->the_post();
						...
						if ($arg['title'] === "Past Exhibitions") {							
							$arg['pLink']  = "http://34.235.158.248/past-exhibitions/";
						} elseif ($arg['title'] === "Future Exhibitions") {							
							$arg['pLink']  = "http://34.235.158.248/future-exhibitions/";
						} else {
